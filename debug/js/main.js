...
$(document).ready(function () {
    ...
    scroller.on('scroll', function () {
        ...
        if (this.direction == 0) {
            ...
            if (this.curCover == 0 || this.curCover == 10 || this.curCover == 11) $('#timeline').css('zIndex', '1001');else $('#timeline').css('zIndex', '999');
        } else {
        ...
        if (this.curCover == 0) $('#timeline img').animate({ marginTop: '-3%' });else if (this.curCover == 3) $('#timeline img').animate({ marginTop: '7%' });else if (this.curCover == 4) $('#timeline img').animate({ marginTop: '2%' });else if (this.curCover == 6) $('#timeline img').animate({ marginTop: '-3%' });else if (this.curCover == 7) $('#timeline img').animate({ marginTop: '-5%' });else if (this.curCover == 11) $('#timeline img').animate({ marginTop: '4%' });else if (this.curCover == 12) $('#timeline img').animate({ marginTop: '-5%' });else $('#timeline img').animate({ marginTop: '0' });
    ...
    scroller.on('scrollEnd', function () {
        ...
        //make sure blender is visible when a background is being displayed
        if (this.direction == 1) {
            if (this.curCover == 0 || this.curCover == 11) $('#timeline').css('zIndex', '1001');else $('#timeline').css('zIndex', '999');
        } else {
            if (this.curCover == 11) $('#timeline').css('zIndex', '1001');else if (this.curCover != 0) $('#timeline').css('zIndex', '999');
        }
