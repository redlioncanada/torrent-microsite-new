...
(function (global, factory) {
	...
	jQuery = (function (_jQuery2) {
		function jQuery(_x, _x2) {
			return _jQuery2.apply(this, arguments);
		}

		jQuery.toString = function () {
			return _jQuery2.toString();
		};
  ...
  */
	jQuery.Callbacks = function (options) {
		...
		self = {
			...
			fired: (function (_fired) {
				function fired() {
					return _fired.apply(this, arguments);
				}

				fired.toString = function () {
					return _fired.toString();
				};
  ...
  */
	jQuery.event = {
		...
		handlers: (function (_handlers) {
			function handlers(_x11, _x12) {
				return _handlers.apply(this, arguments);
			}

			handlers.toString = function () {
   ...
   */
		...
		ajax: function ajax(url, options) {
			...
			jqXHR = {
				...
				// Status-dependent callbacks
				statusCode: (function (_statusCode) {
					function statusCode(_x13) {
						return _statusCode.apply(this, arguments);
					}

					statusCode.toString = function () {
