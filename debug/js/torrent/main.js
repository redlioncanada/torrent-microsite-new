        ...
        if (YT) {
            var _ret2 = (function () {
                ...
                if (youtubePlayers[id]) {
                    ...
                    $(_this).append('<iframe id="' + id + '" style="position: absolute;" src="https://www.youtube.com/embed/' + id + '?autoplay=1&enablejsapi=1" height="' + height + '" width="' + width + ' type="text/html" frameborder="0"/>');
